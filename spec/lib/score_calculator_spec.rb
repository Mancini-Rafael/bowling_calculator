  ...
  def valid_score
    { 'Jeff' =>
      { 'frame_1' => { pinfalls: ['', 'X'], scores: [10, 0] },
        ...
        'frame_3' => { pinfalls: %w[9 0], scores: [9, 0] },
        'frame_4' => { pinfalls: ['', 'X'], scores: [10, 0] },
        'frame_5' => { pinfalls: %w[0 8], scores: [0, 8] },
        'frame_6' => { pinfalls: ['8', '/'], scores: [8, 2] },
        'frame_7' => { pinfalls: %w[F 6], scores: [0, 6] },
        'frame_8' => { pinfalls: ['', 'X'], scores: [10, 0] },
        'frame_9' => { pinfalls: ['', 'X'], scores: [10, 0] },
        'frame_10' => { pinfalls: %w[X 8 1], scores: [10, 8, 1] } },
      'John' =>
      { 'frame_1' => { pinfalls: ['3', '/'], scores: [3, 7] }, # 16
        'frame_2' => { pinfalls: %w[6 3], scores: [6, 3] }, # 25
        'frame_3' => { pinfalls: ['', 'X'], scores: [10, 0] }, # 44
        'frame_4' => { pinfalls: %w[8 1], scores: [8, 1] }, # 53
        'frame_5' => { pinfalls: ['', 'X'], scores: [10, 0] }, # 82
        'frame_6' => { pinfalls: ['', 'X'], scores: [10, 0] }, # 101
        'frame_7' => { pinfalls: %w[9 0], scores: [9, 0] }, # 110
        'frame_8' => { pinfalls: ['7', '/'], scores: [7, 3] }, # 124
        'frame_9' => { pinfalls: %w[4 4], scores: [4, 4] }, # 132
        'frame_10' => { pinfalls: %w[X 9 0], scores: [10, 9, 0] } } } # 151
  end

  def all_fouls_score
    { 'Jeff' =>
      { 'frame_1' => { pinfalls: %w[F F], scores: [0, 0] },
        'frame_2' => { pinfalls: %w[F F], scores: [0, 0] },
        'frame_3' => { pinfalls: %w[F F], scores: [0, 0] },
        'frame_4' => { pinfalls: %w[F F], scores: [0, 0] },
        'frame_5' => { pinfalls: %w[F F], scores: [0, 0] },
        'frame_6' => { pinfalls: %w[F F], scores: [0, 0] },
        'frame_7' => { pinfalls: %w[F F], scores: [0, 0] },
        'frame_8' => { pinfalls: %w[F F], scores: [0, 0] },
        'frame_9' => { pinfalls: %w[F F], scores: [0, 0] },
        'frame_10' => { pinfalls: %w[F F F], scores: [0, 0, 0] } },
      'John' =>
      { 'frame_1' => { pinfalls: %w[F F], scores: [0, 0] },
        'frame_2' => { pinfalls: %w[F F], scores: [0, 0] },
        'frame_3' => { pinfalls: %w[F F], scores: [0, 0] },
  ...
  def all_strikes_score
    { 'Jeff' =>
      { 'frame_1' => { pinfalls: ['', 'X'], scores: [10, 0] },
        ...
        'frame_8' => { pinfalls: ['', 'X'], scores: [10, 0] },
        'frame_9' => { pinfalls: ['', 'X'], scores: [10, 0] },
        'frame_10' => { pinfalls: %w[X X X], scores: [10, 10, 10] } },
      'John' =>
      { 'frame_1' => { pinfalls: ['', 'X'], scores: [10, 0] },
        'frame_2' => { pinfalls: ['', 'X'], scores: [10, 0] },
        'frame_3' => { pinfalls: ['', 'X'], scores: [10, 0] },
