...
describe ScorePresenter do
  ...
  def valid_score
    { 'Jeff' =>
      { 'frame_1' => { pinfalls: ['', 'X'], scores: [10, 0], running_total: 20 },
        ...
        'frame_3' => { pinfalls: %w[9 0], scores: [9, 0], running_total: 48 },
        'frame_4' => { pinfalls: ['', 'X'], scores: [10, 0], running_total: 66 },
        'frame_5' => { pinfalls: %w[0 8], scores: [0, 8], running_total: 74 },
        'frame_6' => { pinfalls: ['8', '/'], scores: [8, 2], running_total: 84 },
        'frame_7' => { pinfalls: %w[F 6], scores: [0, 6], running_total: 90 },
        'frame_8' => { pinfalls: ['', 'X'], scores: [10, 0], running_total: 120 },
        'frame_9' => { pinfalls: ['', 'X'], scores: [10, 0], running_total: 148 },
        'frame_10' => { pinfalls: %w[X 8 1], scores: [10, 8, 1], running_total: 167 } },
      'John' =>
      { 'frame_1' => { pinfalls: ['3', '/'], scores: [3, 7], running_total: 16 },
        'frame_2' => { pinfalls: %w[6 3], scores: [6, 3], running_total: 25 },
        'frame_3' => { pinfalls: ['', 'X'], scores: [10, 0], running_total: 44 },
        'frame_4' => { pinfalls: %w[8 1], scores: [8, 1], running_total: 53 },
        'frame_5' => { pinfalls: ['', 'X'], scores: [10, 0], running_total: 82 },
        'frame_6' => { pinfalls: ['', 'X'], scores: [10, 0], running_total: 101 },
        'frame_7' => { pinfalls: %w[9 0], scores: [9, 0], running_total: 110 },
        'frame_8' => { pinfalls: ['7', '/'], scores: [7, 3], running_total: 124 },
        'frame_9' => { pinfalls: %w[4 4], scores: [4, 4], running_total: 132 },
        'frame_10' => { pinfalls: %w[X 9 0], scores: [10, 9, 0], running_total: 151 } } }
  end
  ...
  def all_fouls_score
    { 'Jeff' =>
      { 'frame_1' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
        'frame_2' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
        'frame_3' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
        'frame_4' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
        'frame_5' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
        'frame_6' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
        'frame_7' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
        'frame_8' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
        'frame_9' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
        'frame_10' => { pinfalls: %w[F F F], scores: [0, 0, 0], running_total: 0 } },
      'John' =>
      { 'frame_1' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
        'frame_2' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
        'frame_3' => { pinfalls: %w[F F], scores: [0, 0], running_total: 0 },
  ...
  def all_strikes_score
    { 'Jeff' =>
      { 'frame_1' => { pinfalls: ['', 'X'], scores: [10, 10], running_total: 30 },
        ...
        'frame_10' => { pinfalls: %w[X X X], scores: [10, 10, 10], running_total: 300 } },
      'John' =>
      { 'frame_1' => { pinfalls: ['', 'X'], scores: [10, 10], running_total: 30 },
        'frame_2' => { pinfalls: ['', 'X'], scores: [10, 10], running_total: 60 },
        'frame_3' => { pinfalls: ['', 'X'], scores: [10, 10], running_total: 90 },
